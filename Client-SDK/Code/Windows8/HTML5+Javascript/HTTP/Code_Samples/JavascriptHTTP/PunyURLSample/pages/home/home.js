(function () {
    ...
    WinJS.UI.Pages.define("/pages/home/home.html", {
        ...
        ready: function (element, options) {
            ...
            var elementById = document.getElementById("btGetCompressedURLByURL");
            elementById.addEventListener("click",
                function () { navigateTo('/pages/tests/GetCompressedURLByURL/GetCompressedURLByURL.html'); });

            elementById = document.getElementById("btGetURLByCompressedURL");
            elementById.addEventListener("click",
                function () { navigateTo('/pages/tests/GetURLByCompressedURL/GetURLByCompressedURL.html'); });
        }
    });
})();
